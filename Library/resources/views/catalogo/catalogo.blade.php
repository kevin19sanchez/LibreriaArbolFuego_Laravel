            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('register.libro')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                ...
                <div class="container">
                    <div class="row">
                        <table id="table_data" class="table">
                            ...
                            <tbody>
                            @foreach ($newbook as $itembook)
                            <tr>
                                <th>{{$itembook->id}}</th>
                                <td>{{$itembook->title}}</td>
                                <td>{{$itembook->author}}</td>
                                <td>{{$itembook->identifier}}</td>
                                <td>{{$itembook->publisher}}</td>
                                <td>{{$itembook->description}}</td>
                                <td>{{$itembook->date}}</td>
                                <td>{{$itembook->type}}</td>
                                <td>{{$itembook->format}}</td>
                                <td>{{$itembook->image}}</td>
                                <td>
                                    <a href="{{route('catalogo.editar', $itembook)}}" class="btn btn-warning btn-sm">Editar</a>

                                    <form action="{{route('catalogo.eliminar', $itembook)}}" class="d-inline" method="POST">
                                        @method('DELETE')
                                        @csrf
