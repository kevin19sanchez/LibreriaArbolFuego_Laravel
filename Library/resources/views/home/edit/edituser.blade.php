            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('register')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <div class="container">
                        <div class="row">
                            <h1>Editar usuario {{$useredit->name_user}}</h1>

                            @if ( session('mensaje') )
                                <div class="alert alert-success">{{ session('mensaje') }}</div>
                            @endif

                            <form class="user" method="post" action="{{ route('usuario.actualizado', $useredit->id) }}">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="name_user"
                                            placeholder="Nombre" name="name_user" value="{{ $useredit->name_user}}">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="lastname_user"
                                            placeholder="Apellido" name="lastname_user" value="{{ $useredit->lastname_user}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="username"
                                        placeholder="Nombre de usuario" name="username" value="{{ $useredit->username}}">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="userpassword" placeholder="Contraseña" name="userpassword"
                                            value="{{ $useredit->userpassword}}">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="userpassword_repeat" placeholder="Confirmar contraseña" name="userpassword_repeat"
                                            value="{{ $useredit->userpassword_repeat}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <select class="form-select" aria-label="Default select example" id="select_cargo" name="select_cargo">
                                            ...
                                            @foreach ($cargos as $cargo)
                                                <option value="{{$cargo->id}}" {{ $useredit->select_cargo == $cargo->id ? 'selected' : ''  }}>{{$cargo->cargo}}</option>
                                            @endforeach
                                          </select>
                                    </div>
                                    <div class="col-sm-6">
                                        <select class="form-select" aria-label="Default select example" id="select_rol" name="select_rol">
                                            ...
                                            @foreach ($roles as $rol)
                                                <option value="{{$rol->id}}" {{$useredit->select_rol == $rol->id ? 'selected' : '' }}>{{$rol->rol}}</option>
                                            @endforeach
                                          </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <select class="form-select" aria-label="Default select example" id="select_sucursal" name="select_sucursal">
                                        ...
                                        @foreach ($sucursales as $sucursal)
                                            <option value="{{$sucursal->id}}" {{$useredit->select_sucursal == $sucursal->id ? 'selected' : '' }}>{{$sucursal->sucursal}}</option>
                                        @endforeach
                                      </select>
                                </div>
